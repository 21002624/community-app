...
export const followUnfollowUser = async (req, res) => {
    try {
        ...
        const currentUser = await User.findById(req.user._id); // Authenticated user from middleware

        if (id === req.user._id.toString()) { // Compare as strings
        ...
        console.log("Error in follow/unfollow functionality:", error);
